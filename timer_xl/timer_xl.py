...
from timer_xl.layers.Transformer_EncDec import TimerDecoderLayer
from timer_xl.layers.Embed import TimerPatchEmbedding
from timer_xl.configuration_timer import TimerxlConfig
from timer_xl.util.masking import prepare_4d_causal_attention_mask
...
class Model(nn.Module):
    ...
    def __init__(self, config: TimerxlConfig):
        ...
        if config.ckpt_path is not None and config.ckpt_path != '':
            ...
            # 如果state_dict中没有'model.model'开头的key，则给所有key前面加上一个'model.'

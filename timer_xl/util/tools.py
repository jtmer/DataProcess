...
def adjust_learning_rate(optimizer, epoch, lradj, learning_rate):
    ...
    if lradj == 'type1':
        lr_adjust = {epoch: learning_rate * (0.1 ** epoch)}
    elif lradj == 'type2':
        lr_adjust = {epoch: learning_rate * (0.5 ** epoch)}
    elif lradj == 'type3':
        lr_adjust = {epoch: learning_rate * (0.9 ** epoch)}
    else:
        raise ValueError('Invalid lradj: {}'.format(lradj))
